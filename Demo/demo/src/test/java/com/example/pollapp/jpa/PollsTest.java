package com.example.pollapp.jpa;
...
public void testUsers() {
    emf.runInTransaction(em -> {
        Number countResult = (Number) em.createNativeQuery("select count(id) from users").getSingleResult();
        Integer actual = countResult.intValue();
